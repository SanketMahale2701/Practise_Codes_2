//Q.accept n numbers from user as well as accept on another number from user and chack the frist index of another number using macro

#include<stdio.h>
#include<stdlib.h>
#define ERR_NOTFOUNT -1            // user define macro
